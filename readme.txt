...
- configuration
    ...
    execution
        ...
        dans le fichier do.sh remplacer le chemin_webapps par le chemin ou se situe les applications java sur votre ordinateur
        dans chemin_bin le chemin vers le dossier bin
...
- Les annotations
    ...
    @isRestApi
        ici à declarer sur une fonciton au cas ou elle retourne un json aussi
